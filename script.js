...
const members = [
    ...
    { id: 8, name: 'Firming Owen', desc: 'Developer', photo: 'owen.JPG', badge: 'TKJ' },
    { id: 9, name: 'Frederick Prajna.S', desc: 'General Affair', photo: 'frederick.JPG', badge: 'TKJ' },
    { id: 10, name: 'Jessica Cornelia', desc: 'The Scenography', photo: 'jessica.JPG', badge: 'TKJ' },
    { id: 11, name: 'Kisardi', desc: 'Creative Editor', photo: 'kisardi.JPG', badge: 'TKJ' },
    { id: 12, name: 'Lorenzo', desc: 'The Scenography', photo: 'lorenzo.JPG', badge: 'TKJ' },
    { id: 13, name: 'Lucky wijaya', desc: 'General Affair', photo: 'lucky.JPG', badge: 'Akuntansi' },
    { id: 14, name: 'Maverick', desc: 'General Affair', photo: 'maverick.JPG', badge: 'TKJ' },
    { id: 15, name: 'Melani Putri.F', desc: 'Secretary', photo: 'melani.JPG', badge: 'Akuntansi' },
    { id: 16, name: 'Nicholas Liem', desc: 'Creative Editor', photo: 'nicholas.JPG', badge: 'TKJ' },
    { id: 17, name: 'Risky Kensen', desc: 'General Affair', photo: 'risky.JPG', badge: 'TKJ' },
    { id: 18, name: 'Selly Susanti', desc: 'Finance Officer & Yearbook Committee', photo: 'selly.JPG', badge: 'Akuntansi' },
    ...
    { id: 21, name: 'Vanessa angelin', desc: 'The Scenography & Yearbook Committee', photo: 'vanessa.jpg', badge: 'Akuntansi' },
